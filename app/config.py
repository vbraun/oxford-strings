...
#             'https://www.maths.ox.ac.uk/events/calendar/P2Y1D/4/930/ical'),
    Calendar('Quantum Field Theory', 
             'https://www.maths.ox.ac.uk/events/series/686/ical/all'),
    Calendar('Geometry and Analysis Seminar', 
             'https://www.maths.ox.ac.uk/events/series/641/ical/all'),
    Calendar('Algebraic and Symplectic Geometry', 
             'https://www.maths.ox.ac.uk/events/series/624/ical/all'),
    Calendar('Number Theory Seminar', 
             'https://www.maths.ox.ac.uk/events/series/669/ical/all'),
### Not yet announced
...
#             ''),
    ...
    Calendar('Relativity Seminar', 
             'https://www.maths.ox.ac.uk/events/series/688/ical/all'),
    Calendar('Physics', 
